...
with(subsetted.power.data, plot(subsetted.power.data$Date_Time, subsetted.power.data$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
with(subsetted.power.data, lines(subsetted.power.data$Date_Time, subsetted.power.data$Sub_metering_2, type="l", col = "red"))
with(subsetted.power.data, lines(subsetted.power.data$Date_Time, subsetted.power.data$Sub_metering_3, type="l", col = "blue"))
